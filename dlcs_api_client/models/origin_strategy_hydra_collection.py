...
T = TypeVar("T", bound="OriginStrategyHydraCollection")


@define
class OriginStrategyHydraCollection:
    """
    Attributes:
        ...
        members (Union[Unset, None, List['OriginStrategy']]):
    ...
    members: Union[Unset, None, List["OriginStrategy"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for members_item_data in _members or []:
            members_item = OriginStrategy.from_dict(members_item_data)
        ...
        origin_strategy_hydra_collection = cls(
            id=id,
        ...
        return origin_strategy_hydra_collection
