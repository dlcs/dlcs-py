...
T = TypeVar("T", bound="SpaceHydraCollection")


@define
class SpaceHydraCollection:
    """
    Attributes:
        ...
        members (Union[Unset, None, List['Space']]):
    ...
    members: Union[Unset, None, List["Space"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for members_item_data in _members or []:
            members_item = Space.from_dict(members_item_data)
