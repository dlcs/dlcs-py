...
T = TypeVar("T", bound="CustomHeaderHydraCollection")


@define
class CustomHeaderHydraCollection:
    """
    Attributes:
        ...
        members (Union[Unset, None, List['CustomHeader']]):
    ...
    members: Union[Unset, None, List["CustomHeader"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for members_item_data in _members or []:
            members_item = CustomHeader.from_dict(members_item_data)
        ...
        custom_header_hydra_collection = cls(
            id=id,
        ...
        return custom_header_hydra_collection
