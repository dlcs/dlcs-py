...
T = TypeVar("T", bound="ThumbnailPolicyHydraCollection")


@define
class ThumbnailPolicyHydraCollection:
    """
    Attributes:
        ...
        members (Union[Unset, None, List['ThumbnailPolicy']]):
    ...
    members: Union[Unset, None, List["ThumbnailPolicy"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for members_item_data in _members or []:
            members_item = ThumbnailPolicy.from_dict(members_item_data)
        ...
        thumbnail_policy_hydra_collection = cls(
            id=id,
        ...
        return thumbnail_policy_hydra_collection
