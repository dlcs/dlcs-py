...
T = TypeVar("T", bound="StoragePolicyHydraCollection")


@define
class StoragePolicyHydraCollection:
    """
    Attributes:
        ...
        members (Union[Unset, None, List['StoragePolicy']]):
    ...
    members: Union[Unset, None, List["StoragePolicy"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for members_item_data in _members or []:
            members_item = StoragePolicy.from_dict(members_item_data)
        ...
        storage_policy_hydra_collection = cls(
            id=id,
        ...
        return storage_policy_hydra_collection
