...
T = TypeVar("T", bound="ImageHydraCollection")


@define
class ImageHydraCollection:
    """
    Attributes:
        ...
        members (Union[Unset, None, List['Image']]):
    ...
    members: Union[Unset, None, List["Image"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for members_item_data in _members or []:
            members_item = Image.from_dict(members_item_data)
