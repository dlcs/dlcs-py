...
T = TypeVar("T", bound="DeliveryChannelPolicyHydraNestedCollection")


@define
class DeliveryChannelPolicyHydraNestedCollection:
    """
    Attributes:
        ...
        members (Union[Unset, None, List['DeliveryChannelPolicy']]):
    ...
    members: Union[Unset, None, List["DeliveryChannelPolicy"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for members_item_data in _members or []:
            members_item = DeliveryChannelPolicy.from_dict(members_item_data)
        ...
        delivery_channel_policy_hydra_nested_collection = cls(
            id=id,
        ...
        return delivery_channel_policy_hydra_nested_collection
