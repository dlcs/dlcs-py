...
T = TypeVar("T", bound="DefaultDeliveryChannelHydraCollection")


@define
class DefaultDeliveryChannelHydraCollection:
    """
    Attributes:
        ...
        members (Union[Unset, None, List['DefaultDeliveryChannel']]):
    ...
    members: Union[Unset, None, List["DefaultDeliveryChannel"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for members_item_data in _members or []:
            members_item = DefaultDeliveryChannel.from_dict(members_item_data)
        ...
        default_delivery_channel_hydra_collection = cls(
            id=id,
        ...
        return default_delivery_channel_hydra_collection
