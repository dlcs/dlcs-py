...
if TYPE_CHECKING:
    from ..models.delivery_channel_policy_hydra_nested_collection import DeliveryChannelPolicyHydraNestedCollection
    from ..models.partial_collection_view import PartialCollectionView


T = TypeVar("T", bound="DeliveryChannelPolicyHydraNestedCollectionHydraCollection")


@define
class DeliveryChannelPolicyHydraNestedCollectionHydraCollection:
    """
    Attributes:
        ...
        members (Union[Unset, None, List['DeliveryChannelPolicyHydraNestedCollection']]):
    ...
    members: Union[Unset, None, List["DeliveryChannelPolicyHydraNestedCollection"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for members_item_data in _members or []:
            members_item = DeliveryChannelPolicyHydraNestedCollection.from_dict(members_item_data)
        ...
        delivery_channel_policy_hydra_nested_collection_hydra_collection = cls(
            id=id,
        ...
        return delivery_channel_policy_hydra_nested_collection_hydra_collection
