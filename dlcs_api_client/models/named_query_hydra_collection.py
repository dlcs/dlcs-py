...
T = TypeVar("T", bound="NamedQueryHydraCollection")


@define
class NamedQueryHydraCollection:
    """
    Attributes:
        ...
        members (Union[Unset, None, List['NamedQuery']]):
    ...
    members: Union[Unset, None, List["NamedQuery"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for members_item_data in _members or []:
            members_item = NamedQuery.from_dict(members_item_data)
        ...
        named_query_hydra_collection = cls(
            id=id,
        ...
        return named_query_hydra_collection
