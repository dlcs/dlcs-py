...
T = TypeVar("T", bound="BatchHydraCollection")


@define
class BatchHydraCollection:
    """
    Attributes:
        ...
        members (Union[Unset, None, List['Batch']]):
    ...
    members: Union[Unset, None, List["Batch"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for members_item_data in _members or []:
            members_item = Batch.from_dict(members_item_data)
