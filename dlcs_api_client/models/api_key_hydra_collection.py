...
T = TypeVar("T", bound="ApiKeyHydraCollection")


@define
class ApiKeyHydraCollection:
    """
    Attributes:
        ...
        members (Union[Unset, None, List['ApiKey']]):
    ...
    members: Union[Unset, None, List["ApiKey"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for members_item_data in _members or []:
            members_item = ApiKey.from_dict(members_item_data)
        ...
        return api_key_hydra_collection
