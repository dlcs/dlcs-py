...
T = TypeVar("T", bound="DeliveryChannelPolicyHydraCollection")


@define
class DeliveryChannelPolicyHydraCollection:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        delivery_channel_policy_hydra_collection = cls(
            id=id,
        ...
        return delivery_channel_policy_hydra_collection
