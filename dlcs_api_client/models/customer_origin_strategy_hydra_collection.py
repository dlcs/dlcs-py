...
T = TypeVar("T", bound="CustomerOriginStrategyHydraCollection")


@define
class CustomerOriginStrategyHydraCollection:
    """
    Attributes:
        ...
        members (Union[Unset, None, List['CustomerOriginStrategy']]):
    ...
    members: Union[Unset, None, List["CustomerOriginStrategy"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for members_item_data in _members or []:
            members_item = CustomerOriginStrategy.from_dict(members_item_data)
        ...
        customer_origin_strategy_hydra_collection = cls(
            id=id,
        ...
        return customer_origin_strategy_hydra_collection
