...
if TYPE_CHECKING:
    from ..models.identifier_only import IdentifierOnly
    from ..models.partial_collection_view import PartialCollectionView


T = TypeVar("T", bound="IdentifierOnlyHydraCollection")


@define
class IdentifierOnlyHydraCollection:
    """
    Attributes:
        ...
        members (Union[Unset, None, List['IdentifierOnly']]):
    ...
    members: Union[Unset, None, List["IdentifierOnly"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for members_item_data in _members or []:
            members_item = IdentifierOnly.from_dict(members_item_data)
        ...
        identifier_only_hydra_collection = cls(
            id=id,
        ...
        return identifier_only_hydra_collection
